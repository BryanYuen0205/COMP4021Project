...
//     // This function detects if the user is typing
//     const typing = function(user) {
//         const currentUser = Authentication.getUser();
//         clearTimeout(timer);
//         if(currentUser.username != user.username){
//             // console.log("im in the typing function");
//             const chatTypingStatus = $("#chat-typing");   
//             chatTypingStatus.html(user.username + " is typing...");
//             timer = setTimeout(() => {
//                 chatTypingStatus.html("");
//             }, 3000);
//         }
//     }
